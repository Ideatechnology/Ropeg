...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
	...
	<title>ROPEG SETJEN KEMENDAGRI</title>
...
<div id="navigation">
		<div class="container-fluid">
			<a href="#" id="brand">
			ROPEG SETJEN KEMENDAGRI  <?php #echo $this->session->userdata('sesi_nama_cabang');?>
			</a>
			...
			<div class="user">
				...
				<ul class="icon-nav">
					...
					<li class='dropdown language-select'>
						<a href="#" class='dropdown-toggle' data-toggle="dropdown"><img src="<?php echo base_url()?>assets/img/demo/flags/us.gif" alt=""><span>US</span></a>
						<ul class="dropdown-menu pull-right">
							<li>
								<a href="#"><img src="<?php echo base_url()?>assets/img/demo/flags/br.gif" alt=""><span>Brasil</span></a>
							</li>
							<li>
								<a href="#"><img src="<?php echo base_url()?>assets/img/demo/flags/de.gif" alt=""><span>Deutschland</span></a>
							</li>
							<li>
								<a href="#"><img src="<?php echo base_url()?>assets/img/demo/flags/es.gif" alt=""><span>España</span></a>
							</li>
							<li>
								<a href="#"><img src="<?php echo base_url()?>assets/img/demo/flags/fr.gif" alt=""><span>France</span></a>
							</li>
						</ul>
					</li>-->
				</ul>
				...
				<div class="dropdown">
					<a href="#" class='dropdown-toggle' data-toggle="dropdown"><?php echo $this->session->userdata('sesi_nama_lengkap'); ?> <img src="<?php echo base_url()?>assets/img/demo/user-avatar.jpg" alt=""></a>
					<ul class="dropdown-menu pull-right">
						<li>
		...
		<div id="main" style="margin-left:0px;">
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left">
						<h1>
						<i class="icon-circle-arrow-left"></i>&nbsp;<a href="<?php echo site_url();?>backpage">Main Menu</a>
						</h1>
					</div>

<div class="row-fluid">
	<div class="span12">
		<div class="box box-color box-bordered">
			<div class="box-title">
				<h3><i class=" icon-plus-sign"></i>Tambah Menu Hirarki</h3>
			</div>
			...
			<div class="box-content">
				...
				<div class="control-group">
					...
					<input type="button" name="button" value="Pilih" onclick="Cari_menu();" />
                    </div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls"><!--class='ckeditor span12' -->
						<textarea name="description" id="description" rows="10"> <?php echo isset($field['description'])?$field['description']:''?></textarea>
					</div>
				</div>
                <hr>	
...
function Cari_menu(){
	...
	$('.table-header').append('<button type="button" class="close" data-dismiss="modal" onClick="modal_keluar();">&times;</button><h3 id="myModalLabel">Hirarki Menu</h3>'); 

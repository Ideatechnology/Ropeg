<div class="row-fluid">
	<div class="span12">
		<div class="box box-color box-bordered">
			<div class="box-title">
				<h3><i class=" icon-plus-sign"></i>Edit Menu Hirarki - Tahun Pemilu <?php echo $tahun; ?></h3>
			</div>
                            
			<div class="box-content">
				<?php 
					echo form_open('bpublik/simpan_edit',array('name'=>'inputForm', 'id'=>'inputForm','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));
				...
				<div class="control-group">
					...
					<input type="button" name="button" value="Pilih" onclick="Cari_menu();" class="btn btn-important"/>
                    </div>
				</div>
				<div class="control-group">
				...
				<div class="form-actions">
					...
					<a class="btn btn-danger"  href="<?php echo site_url();?>bpublik/index/<?php echo $tahun; ?>">Kembali</a>
...
function Cari_menu(){
	...
	var url = '<?php echo site_url();?>bpublik/cari_menu/<?php echo $tahun; ?>';
	document.getElementById('lyar-mask').style.display='block';
	$('.table-header').append('<button type="button" class="close" data-dismiss="modal" onClick="modal_keluar();">&times;</button><h3 id="myModalLabel">Hirarki Menu <?php echo $tahun; ?></h3>'); 

...
<div class="row-fluid">
	<div class="span12">
		<div class="box box-color box-bordered">
			<div class="box-title">
				<h3><i class="icon-table"></i> Daftar Menu Publik</h3>
				<div class="actions">
					<a href="<?php echo site_url('bpublik/open_form')?>" class="btn btn-mini btn-success"><i class="icon-plus"></i> &nbsp; Tambah Menu</a>
				</div>
			</div>

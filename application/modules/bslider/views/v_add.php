...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Add Slider Front Page</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('bslider/submit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
                                    ...
                                    <div class="control-group">
										...
										<textarea name="slider_desc" class='input-xxlarge' rows="10"></textarea>
                                     ...
                                     <div class="control-group">
										...
										<div class="controls">
											<input type="file" name="userfile"  data-rule-required="true"/> (jpg,jpeg,png) 784 x 335 pixels
										</div>
									</div>

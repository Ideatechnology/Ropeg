...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Add Our Reference</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('bbanner/submit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
                                    ...
                                    <div class="control-group">
										...
										<textarea name="banner_desc" class='input-xxlarge' rows="10" placeholder="Description"></textarea>
                                     ...
                                     <div class="control-group">
									  ...
									  <div class="control-group">
											...
											<div class="controls">
												<input type="text" name="banner_link" id="banner_link" class="input-xxlarge" data-rule-required="true">

...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Edit Files</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('bfiles/submitedit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
									...
									?>
									  ...
									  <input type="hidden" name="id_files" id="id_files" class="input-large" data-rule-required="true" value="<?php echo $id_files; ?>"> 
                                    ...
                                    <div class="control-group">
										...
										<textarea name="desc" class='input-xxlarge' rows="10" placeholder="Description"><?php echo $keterangan; ?></textarea>
                                     ...
                                     <div class="control-group">
										...
										<div class="controls">
											<input type="file" name="userfile" />( jpeg,jpg,png 84x46px)
										</div>
									</div>
									  ...
									  <div class="control-group">
											...
											<div class="controls">
												...
												<option value="<?php echo $kategori_row->id_kategori_files;?>" <?php echo $kategori_row->id_kategori_files==$id_kategori?"selected":"";?>><?php echo $kategori_row->kategori_file;?></option>

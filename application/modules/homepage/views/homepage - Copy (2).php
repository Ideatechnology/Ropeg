...
.nav-tabs>li>a:hover {
  ...
  background-color: #111111;
    ...
    <div class="container">
		...
		<div class="row">
            ...
            <div style="background-color:#FF9900; color:#FFFFFF; text-align:center; font-weight:bold; padding:5px;">BERITA</div>
                ...
                <h5>
				   ...
				   <a href="<?php echo site_url();?>berita_kesehatan/detil/<?php echo $row_berita_kes->id_news; ?>">
				   <?php echo $row_berita_kes->news_title; ?>
				   </a>
				   </span>
                </h5>
                <p align="justify">
            ...
            <div class="col-md-3 img-portfolio">
            <div style="background-color:#FF9900; color:#FFFFFF; text-align:center; font-weight:bold; padding:5px;">WAWASAN</div>
                ...
                <h5>
                   <span style="color:#FF9900; font-weight:bold;">
				   <a href="<?php echo site_url();?>berita_farmasi/detil/<?php echo $row_berita_farmasi->id_news; ?>">
				   <?php echo $row_berita_farmasi->news_title; ?></span>
				   </a>
                </h5>
                <p align="justify">
				<span style="color:#999999; font-size:9px;">
				
				<?php echo $row_berita_farmasi->create_time; ?>
			...
			<div class="col-md-3 img-portfolio">
            <div style="background-color:#FF9900; color:#FFFFFF; text-align:center; font-weight:bold; padding:5px;">TINJAUAN</div>
                ...
                <h5>
                   <span style="color:#FF9900; font-weight:bold;">
				   <a href="<?php echo site_url();?>health_travel/detil/<?php echo $row_berita_travel->id_news; ?>">
				   <?php echo $row_berita_travel->news_title; ?></span>
				   </a>
                </h5>
                <p align="justify">
            ...
            <div class="col-md-3 img-portfolio">
            <div style="background-color:#FF9900; color:#FFFFFF; text-align:center; font-weight:bold; padding:5px;">KONSULTASI</div>
     ...
     <li>
       ...
       <?php } ?>
               ...
               <div align="center"><a href="<?php echo site_url(); ?>konsultasi/kirim/" class="btn btn-warning">Kirim konsultasi</a></div>
		...
		<div align="center"><img alt="" src="<?php echo base_url()?>uploads/promo/<?php echo $thumb; ?>" class="img-responsive img-hover"></div><br>
 ...
 <div class="control-group form-group">
		...
		<span style="color:#FF9900; font-weight:bold; font-size:14px;">MOST POPULAR</span>
         <div style="border-top:solid #FF9900 5px; padding:5px;">
		
		<ul class="list_paper">  
		
		<?php 
			
			foreach($popular->result_array() as $row_popularx){ 
     ...
     <li>
         ...
         <h6>
		 <span class="name"><?php echo $row_popularx['create_time']; ?>  </span>
		 <a href="<?php echo site_url(); ?>berita_kesehatan/detil/<?php echo $row_popularx['id_news']; ?>"><?php echo $row_popularx['news_title']; ?> </a>
		 </h6>  
    </li>
       <?php } ?>
		...
		<span style="color:#FF9900; font-weight:bold; font-size:14px;">MOST COMMENT</span>
        <div style="border-top:solid #FF9900 5px; padding:5px;">
		...
		<?php 
			...
			foreach($komen->result_array() as $row_komenx){ 
     ...
     <li>
		 ...
		 <a href="<?php echo site_url(); ?>berita_kesehatan/detil/<?php echo $row_komenx['id_news']; ?>"><?php echo $row_komenx['news_title']; ?> </a>
          <em><span class="name"><?php echo $row_komenx['comments']; ?>  </span> Komentar</em>
		 </h6>  
    </li>
       <?php } ?>

...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Edit Data News Category</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('bnews_category/submitedit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
									...
									<div class="control-group">
											...
											<label for="textfield" class="control-label"> News Category</label>
											<div class="controls">

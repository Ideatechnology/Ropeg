...
<div class="box-title">
								<h3><i class=" icon-plus-sign"></i>Add Events</h3>
								<div class="actions">
 ...
 <div class="box-content">
								...
								<?php echo form_open('bkevents/submit',array('name'=>'bb', 'id'=>'bb','class'=>'form-horizontal form-validate form-wysiwyg','enctype'=>'multipart/form-data'));?>
                                    ...
                                    <div class="control-group">
										 ...
										 <div class="control-group">
											...
											<div class="controls">
												<input type="text" name="tanggal" id="tanggal" class="input-xxsmall datepick" data-date-format="yyyy-mm-dd" data-rule-required="true">
										...
										<textarea name="desc" class='ckeditor span12' rows="10"
							></textarea>
